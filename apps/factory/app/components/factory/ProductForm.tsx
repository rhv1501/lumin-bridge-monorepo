  ...
  return (
    <Card className="p-8 sm:p-10 border-0 shadow-2xl bg-white/90 dark:bg-zinc-900/90 backdrop-blur-2xl rounded-[2rem]">
      <div className="flex justify-between items-center mb-10">
        ...
        <button
          onClick={onCancel}
          className="p-2.5 text-zinc-500 dark:text-zinc-300 hover:text-zinc-600 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-700 dark:bg-zinc-800 rounded-full transition-colors"
        >
          <X size={20} />
        </button>
      </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Input
                ...
                type="number"
                step="0.01"
                {...register("factory_price_cny", { valueAsNumber: true })}
                placeholder="0.00"
              />
            </div>
          </div>
            ...
            <div className="flex-1 min-h-[300px] rounded-[2rem] border-2 border-dashed border-zinc-200 dark:border-zinc-700 flex flex-col items-center justify-center bg-zinc-50/50 dark:bg-zinc-800/20 relative group overflow-hidden">
              ...
              {photoPreview ? (
                ...
                <div className="flex flex-col items-center">
                  <ImageIcon
                    className="text-zinc-500 dark:text-zinc-400 mb-2"
                    size={32}
                  />
