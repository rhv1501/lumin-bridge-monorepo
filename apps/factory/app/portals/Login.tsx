...
import { User as UserType, UserRole } from "@luminbridge/types";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4 font-sans text-zinc-900 dark:text-zinc-50 antialiased">
      ...
      >
        ...
        <Card className="p-6 sm:p-8 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-xl">
          {allowSignup && (
