    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <Card className="p-8 border-0 shadow-2xl bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-[2.5rem]">
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white mb-2">Leave a Review</h3>
            <p className="text-sm text-zinc-500">How was your experience with {order.product_name}?</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              <label className="text-[11px] font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-400 ml-1">Your Comments</label>
              <textarea
                value={comment}
