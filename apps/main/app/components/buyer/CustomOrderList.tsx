              ...
              <div className="flex items-center justify-between p-8 sm:p-10 border-b border-zinc-100 dark:border-zinc-800/50 shrink-0">
                ...
                <div className="flex items-center gap-4">
                  <Button
                    ...
                    className="relative h-12 rounded-full px-8"
                  >
                        ...
                        <div className="py-20 flex flex-col items-center justify-center text-center space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-zinc-500 max-w-sm mt-1">
                              Our global factory network is currently reviewing
                              your requirements. You'll be notified as soon as a
                              proposal is sent.
                            </p>
                          </div>
                        </div>
                                ...
                                <div className="space-y-3">
                                  ...
                                  <div className="flex items-baseline gap-2">
                                    <span className="text-4xl font-mono font-bold tracking-tighter text-zinc-900 dark:text-white">
                                      ₹{p.price_inr?.toLocaleString() || "TBD"}
                                    </span>
