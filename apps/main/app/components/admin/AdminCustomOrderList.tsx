...
export const AdminCustomOrderList = ({
  customOrders,
  proposals,
  isLoading,
  currentUser,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {isLoading ? (
          ...
          customOrders.map((co) => (
            <Card
              key={co.id}
              className="overflow-hidden hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-[2rem] group h-full flex flex-col"
            >
                  ...
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex items-center gap-2">
                        <span className="text-[10px] font-bold uppercase text-zinc-500 dark:text-zinc-400 tracking-widest">
                          Request #{co.id}
                        </span>
